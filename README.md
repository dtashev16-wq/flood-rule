...
<head>
    ...
    <style>
        ...
        .container {
            ...
            margin: 50px auto;
            padding: 25px;
            background-color: #111; /* чуть светлее черного для блока */
            border-radius: 10px;
        }
        ...
        hr {
            ...
            border: 0;
            border-top: 1px solid #e0e0c8; /* тонкая линия */
        }
    </style>
</head>
<body>
    <div class="container">
        <h1>Правила флуда</h1>
        <p>Добро пожаловать в <strong>(название)</strong>. Это флуд по Геншину, где вы сможете общаться, заводить новые знакомства, смеяться и просто приятно проводить время с другими игроками.</p>
